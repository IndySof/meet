...
export default function ConfigAvailability({ configSetAvailability }: { configSetAvailability: AvailabilitySlotsMap }) {
  ...
  return (
    <div id="availability-section" className="mb-6 mx-auto max-w-2xl">
      ...
      <br />
      <h2 className="mt-3">
        <b className="text-lg">Notes</b> : Pour configurer une journée entière sans pause ou uniquement une demi-journée,
        vous devez paramétrer la même heure pour la pause, la reprise et la fin.
      </h2>
      <br />
                    ...
                    <td className="border px-3 py-2">
                      {slots.length > 0 ? (
                        slots.map((slot, idx) => (
                          <div key={idx} className="flex justify-center">
                            <input
                              ...
                              onChange={(e) =>
                                handleInputChange("start", idx, e.target.value)
                              }
                        ...
                        <input
                          ...
                          className="block rounded-md border-gray-300 shadow-sm focus:ring-accent-600 focus:border-accent-600 sm:text-sm"
                          onChange={(e) =>
                            handleInputChange("start", 0, e.target.value)
                          }
                        />
                      )}
                    </td>
                    ...
                    <td className="border px-3 py-2">
                      {slots.length > 0 ? (
                        slots.map((slot, idx) => (
                          <div key={idx} className="flex justify-center">
                            <input
                              type="time"
                              value={formatTime(
                                slot.breakStart.hour,
                                slot.breakStart.minute
                              )}
                              onChange={(e) =>
                                handleInputChange(
                                  "breakStart",
                        ...
                        <input
                          ...
                          className="block rounded-md border-gray-300 shadow-sm focus:ring-accent-600 focus:border-accent-600 sm:text-sm"
                          onChange={(e) =>
                            handleInputChange("breakStart", 0, e.target.value)
                          }
                        />
                      )}
                    </td>
                    ...
                    <td className="border px-3 py-2">
                      {slots.length > 0 ? (
                        ...
                        <input
                          ...
                          className="block rounded-md border-gray-300 shadow-sm focus:ring-accent-600 focus:border-accent-600 sm:text-sm"
                          onChange={(e) =>
                            handleInputChange("breakEnd", 0, e.target.value)
                          }
                        />
                      )}
                    </td>
                    ...
                    <td className="border px-3 py-2">
                      {slots.length > 0 ? (
                        slots.map((slot, idx) => (
                          <div key={idx} className="flex justify-center">
                            <input
                              ...
                              onChange={(e) =>
                                handleInputChange("end", idx, e.target.value)
                              }
                              className="block rounded-md border-gray-300 shadow-sm focus:ring-accent-600 focus:border-accent-600 sm:text-sm"
                            />
                          </div>
                        ...
                        <input
                          ...
                          className="block rounded-md border-gray-300 shadow-sm focus:ring-accent-600 focus:border-accent-600 sm:text-sm"
                          onChange={(e) =>
                            handleInputChange("end", 0, e.target.value)
                          }
                        />
                      )}
                    </td>
